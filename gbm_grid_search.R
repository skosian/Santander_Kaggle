...
print(paste("GBM Grid:",i," ",top_products[i]))
 ...
 auc_temp=data.frame(i,top_products[i],auc_train,auc_valid,auc_test)
...
# Get the mean valus of predictions on all data sets and export to CSV
...
auc_report_Nov8 <- auc_report

write.csv(mean_predictions,file="C:/Santander/Data/mean_predictions_tuned_GBM_Nov8.csv")
write.csv(auc_report_Nov8,file="C:/Santander/Data/auc_report_tuned_GBM_Nov8.csv")
...
write.csv(submission[,1:2],file="C:/Santander/Submissions/submission5.csv",row.names = FALSE)
