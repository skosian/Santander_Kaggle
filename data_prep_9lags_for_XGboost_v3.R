...
train100K_9lags_v3 <- dplyr::left_join(train100K_with_lags[,!(names(train100K_with_lags) %in% factor_columns)],dummies.df,by=c("ncodpers","fecha_dato"))
train100K_9lags_v3 <- dplyr::arrange(train100K_9lags_v3,ncodpers,fecha_dato)
...
save(train100K_9lags_v3,file="C:/Santander/Data/train100K_with_lags_dummies.RData")
load("C:/Santander/Data/train100K_with_lags.RData")
load("C:/Santander/Data/train100K_with_lags_dummies.RData")


numeric_columns <- names(train100K_9lags_v3[,sapply(train100K_9lags_v3,is.numeric)])

cor_9lags_v3=stats::cor(train100K_9lags_v3[,numeric_columns],method=c("pearson"),use = "pairwise.complete.obs")
write.csv(cor_9lags_v3,file = "C:/Santander/EDA/cor_train100K_9lags_v3.csv")
...
temp_train=subset(train[,c("ncodpers","fecha_dato",product_columns,"num_products")],as.character(fecha_dato) > '2015-10-28')
...
test_9lags_v3 <- dplyr::left_join(test_with_lags[,!(names(test_with_lags) %in% factor_columns)],dummies.df,by=c("ncodpers","fecha_dato"))
test_9lags_v3=dplyr::arrange(test_9lags_v3,ncodpers)

# save(test_with_lags,file="C:/Santander/Data/test_with_lags.RData")
save(test_9lags_v3,file="C:/Santander/Data/test_9lags_v3.RData")

# load("C:/Santander/Data/test_with_lags_6lags_plus.RData")
load("C:/Santander/Data/test_9lags_v3.RData")
...
train300K_9lags_v3 <- dplyr::left_join(train300K_with_lags[,!(names(train300K_with_lags) %in% factor_columns)],dummies.df,by=c("ncodpers","fecha_dato"))
train300K_9lags_v3 <- dplyr::arrange(train300K_9lags_v3,ncodpers,fecha_dato)
train300K_9lags_v3 <- dplyr::filter(train300K_9lags_v3,fecha_dato > '2015-09-28')
# test_with_lags_dummies <- dplyr::left_join(test_with_lags[,!(names(test_with_lags) %in% factor_columns)],dummies.df,by=c("ncodpers","fecha_dato"))


save(train300K_9lags_v3,file="C:/Santander/Data/train300K_with_lags_dummies.RData")
load("C:/Santander/Data/train300K_with_lags.RData")
load("C:/Santander/Data/train300K_with_lags_dummies.RData")


numeric_columns <- names(train300K_9lags_v3[,sapply(train300K_9lags_v3,is.numeric)])

cor_9lags_v3=stats::cor(train300K_9lags_v3[,numeric_columns],method=c("pearson"),use = "pairwise.complete.obs")
write.csv(cor_9lags_v3,file = "C:/Santander/EDA/cor_train300K_9lags_v3.csv")
