...
train150K_9lags_v4_imputed=dplyr::sample_frac(train300K_9lags_v4_imputed,size=0.5)

## Split into modeling and valiation sets by month

mod=dplyr::filter(train150K_9lags_v4_imputed,fecha_dato >'2015-11-28' & fecha_dato <= '2016-03-28')
val=dplyr::filter(train150K_9lags_v4_imputed,fecha_dato > '2016-03-28')
...
mod_train=dplyr::sample_frac(mod,size=0.5)
...
for (i in 1:21) #length(top_products)) 
 {
